...
function ProductCard({ props }: { props: Product }) {
  ...
  return (
    <Link
      to={`/product/${id}`}
      className="group flex h-[80vh] snap-start snap-always scroll-mt-3 flex-col overflow-hidden
      rounded-3xl shadow-md transition-[transform,box-shadow] duration-500 md:h-[600px]
