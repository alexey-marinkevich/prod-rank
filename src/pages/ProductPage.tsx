  ...
  return (
    <div>
      <section className="grid">
        ...
        <article className="col-start-1 row-start-1 lg:row-start-2 lg:grid lg:grid-cols-[7fr,1fr]">
          <figure
            ...
            lg:col-start-1 lg:col-end-3 lg:row-start-2 lg:row-end-4 lg:h-[80vh] lg:items-start
          '
          >
            {/* icon */}
            <a
          ...
          <h1
            className="lg:text-writing-mode p-5 px-10 text-center text-4xl
              font-semibold lg:col-start-3 lg:col-end-4 lg:row-start-1 lg:row-end-5 lg:max-h-[920px] lg:text-6xl"
          >
            Atoms Shoes
          </h1>
          <p className="m-auto max-w-2xl p-2 pb-8 text-lg lg:col-start-1 lg:col-end-4 lg:row-start-4 lg:row-end-5 lg:p-10">
